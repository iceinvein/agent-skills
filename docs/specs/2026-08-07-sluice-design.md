...
4. Fast-channel invocation cost is under 1100 tokens. Measured at 848 with a real tokenizer against superpowers' 12,700, so the exact ceiling matters far less than the ratio; it was raised from 900 to fit the routing contract and the conflict warning, both of which the router had promised and not shipped.
